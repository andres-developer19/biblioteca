...
<table width="750" border="0" cellpadding="6" cellspacing="0" >
  <tbody><tr>
    ...
    <div align="right" class="pdf"><a href="pdf/docentes.php" target="_blank"><img src="imagenes/pdf.png" ></a></div>
    <big style="color: rgb(255, 255, 255);"><b> <p style="font-family:Agent Orange;"> LISTA DE DOCENTES</p> </b></big></td>
   ...
   <table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
        <thead>
            <tr>
               ...
               <!-- <th width="80"><h3>Tel&eacute;fonos</h3></th> -->
                <th width="80"><h3>Direccion</h3></th>
            </tr>
        </thead>
        <tbody>
<?php
  ...
  $bd="biblioteca";
  $sql="SELECT * FROM persona WHERE tipo='Docente'";
