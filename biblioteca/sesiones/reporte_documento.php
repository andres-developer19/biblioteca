...
<table width="750" border="0" cellpadding="6" cellspacing="0">
  <tbody><tr>
    ...
    <div align="right" class="pdf"><a href="pdf/documentos.php" target="_blank"><img src="imagenes/pdf.png" ></a></div>
    <big style="color: rgb(255, 255, 255);"><b>
     <p style="font-family:Agent Orange;"> LISTA DE DOCUMENTOS</p> </b></big></td>
   ...
   <table cellpadding="0" cellspacing="0" border="0" id="table" class="sortable">
        <thead>
            <tr>
                ...
                <th width="80"><h3>Tipo</h3></th>
                <th width="80"><h3>Nombre</h3></th>
                <th width="80"><h3>Area</h3></th>
...
<?php
  ...
  $bd="biblioteca";
  $sql="SELECT * FROM lib_doc, documento where lib_doc.cota=documento.cota_doc";
